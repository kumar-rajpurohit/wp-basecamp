...
<body class="cleanpage">
    <?php if ( ! ( is_user_logged_in() ) ) : ?>
		<div class="wisdm-central-no-access">
			<p><?php esc_html_e( 'Please login to manage your message boards.', 'wdm_instructor_role' ); ?></p>
			<p>
				<?php
				echo wp_kses(
					sprintf(
	...
	<?php else : ?>
        <?php echo do_blocks(
            '<!-- wp:wisdm-central/board -->
            <div class="wp-block-wisdm-central-board" data-post-id="'.get_the_ID().'"><div class="wisdm-central-container-board"></div></div>
            <!-- /wp:wisdm-central/board -->
